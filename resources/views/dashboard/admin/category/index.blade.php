...
<div class="space-y-4">
    <div class="p-2 flex items-center justify-between">
        <h2 class="text-lg font-semibold text-dark-blue">Category</h2>
        <a href="{{ route('dashboard.admin.category.create') }}" class="flex items-center rounded px-3 py-1 text-white bg-dark-blue hover:bg-dark-blue/70 cursor-pointer">
            Tambah
        </a>
    </div>
                ...
                <tr class="border-b border-dark-blue/20 hover:bg-dark-blue/20">
                    ...
                    <td class="p-2">
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('dashboard.admin.category.update', $category->id) }}" class="text-royal-blue cursor-pointer"><x-icon name="pencil" class="size-5" /></a>
