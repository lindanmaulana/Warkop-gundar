...
<div class="space-y-6 pb-10 md:pb-0">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('dashboard.orders.cart') }}" class="flex items-center justify-start max-w-20 gap-1 bg-dark-blue text-sm px-4 py-1 text-white rounded"><x-icon name="arrow-left" /> Back</a>
    </div>
    <div class="w-full flex flex-col p-2 gap-6">
        <div class="bg-white p-4 rounded-lg shadow-sm shadow-dark-blue/10 space-y-2" id="cart-list">
            ...
            <input type="text" value="{{ old('email', $user->email) }}" class="w-full px-4 py-2 rounded-lg border border-dark-blue/20 text-dark-blue/50 text-sm" readonly>
        ...
        <div class="" id="cart-list">
            <form onsubmit="handleSubmit(event)" class="space-y-4">
                <div class="space-y-2 flex flex-col md:flex-row gap-4">
                    <div class="w-full md:w-2/3 bg-white p-4 shadow-sm shadow-dark-blue/10  rounded-lg">
                        ...
                        <label for="customer_name" class="flex flex-col gap-2">
                            ...
                            <input type="text" id="customer_name" name="customer_name" class="w-full border border-dark-blue/20 px-4 py-1 rounded-lg">
                        </label>
                    ...
                    <div class="w-full md:w-1/3 max-h-[200px] bg-white p-4 rounded-lg shadow-sm shadow-dark-blue/10 space-y-2" id="cart-list">
